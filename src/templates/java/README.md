...
- Then, update the `src/test/java/com/kobiton/scriptlessautomation/Config.java` file:
  ...
  - Use an Appium 2.x server in the capabilities by specifying `appiumVersion` in `sauce:options`
...
- Then, update the `src/test/java/com/kobiton/scriptlessautomation/Config.java` file:
  ...
  - Use an Appium 2.x server in the capabilities by specifying `appiumVersion` in `bstack:options`
...
- Then, update the `src/test/java/com/kobiton/scriptlessautomation/Config.java` file:
  ...
  - Use an Appium 2.x server in the capabilities by specifying `appiumVersion` in `lt:options`

## Environment Setup

- Install JDK 17 (https://adoptium.net/) or above
